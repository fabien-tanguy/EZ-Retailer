...
describe Admin::PagesController do
  ...
  let(:valid_attributes) { { "titre_menu" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved page as @page" do
        ...
        post :create, {:page => { "titre_menu" => "invalid value" }}, valid_session
        assigns(:page).should be_a_new(Page)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested page" do
        ...
        Page.any_instance.should_receive(:update_attributes).with({ "titre_menu" => "MyString" })
        put :update, {:id => page.to_param, :page => { "titre_menu" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the page as @page" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Page.any_instance.stub(:save).and_return(false)
        put :update, {:id => page.to_param, :page => { "titre_menu" => "invalid value" }}, valid_session
        assigns(:page).should eq(page)
      end
